...
public class Ejercicio27 {
    public static void main(String[] args) {
        ...
        try {
            ...
            borrarValorIngresado(arreglo, valorUsuario);
        } catch (Exception e) {
    ...
    public static void borrarValorIngresado(int[] arreglo, int valorIngresado){
        ...
        while (i<arreglo.length) {
            ...
            if (contadorSecuencia == valorIngresado) {
                finalGuardado = posFinal;
                inicioGuardado = posIni;
                for(int j = inicioGuardado;j<=posFinal;j++){
                    corrimientoIzquierda(arreglo, j);
                }
            } else{
                System.out.println("No hay secuencia de ese tamaño");
                i = arreglo.length;
            }
            contadorSecuencia = 0;   
            i++;
